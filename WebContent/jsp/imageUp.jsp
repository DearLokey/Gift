...
<%@ page import="com.gift.utils.Uploader"%>
...
<%
	...
	response.getWriter().print(
			"{'original':'" + up.getOriginalName() + "','url':'"
					...
					+ "','state':'" + up.getState() + "'}");
	List<String> list = up.getList(); //获取Uploader中的静态list
	list.add(up.getUrl()); //向列表中增加图片路径,传几张，加几次
	request.getSession().setAttribute("picPathList", list); //存入session
%>
